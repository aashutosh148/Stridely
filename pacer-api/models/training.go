...
type TrainingBlock struct {
	...
	TargetRace NullTime    `json:"target_race,omitempty"`
	GoalTimeS  NullInt32   `json:"goal_time_s,omitempty"`
	PeakCTL    NullFloat64 `json:"peak_ctl,omitempty"`
...
type Workout struct {
	...
	DistanceKM          NullFloat64 `json:"distance_km,omitempty"`
	DurationMin         NullInt32   `json:"duration_min,omitempty"`
	PaceTargetMin       NullFloat64 `json:"pace_target_min,omitempty"`
	PaceTargetMax       NullFloat64 `json:"pace_target_max,omitempty"`
	HRZone              NullInt32   `json:"hr_zone,omitempty"`
	RPETarget           NullInt32   `json:"rpe_target,omitempty"`
	Description         NullString  `json:"description,omitempty"`
	Purpose             NullString  `json:"purpose,omitempty"`
